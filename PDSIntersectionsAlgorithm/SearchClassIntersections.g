...
#The purpose of this file is to take the set of prelim_cl_ints and build all class ints, called cl_ints,
#satisfying the restriction that cl_ints[i] = prelim_cl_ints[i] mod moduli[i].
...
##############################################################################################################
####FILTRATION################################################################################################
#This section is dedicated to efficiently filtering comb_cl_ints_lst, to select only those comb_cl_ints
#whic
...
AllClassIntersections := function(group_param_rec, prelim_cl_ints, moduli)
    local
    ...
    stack_size := (group_param_rec.k-Sum(prelim_cl_ints)); 
